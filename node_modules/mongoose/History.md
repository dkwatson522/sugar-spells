 ...
 * fix(model): correctly handle `createIndex` option to `createIndexeses()` #7036 #6922 [lineus](https://github.com/lineus)
 ...
 * fix: add global option `mongoose.set('useCreateIndex', true)` to avoid createIndexes deprecation warning #6890
 ...
 * feat(model): make createIndexeses() fail if specifying an index on _id #6605
 ...
 * fix: undeprecate `createIndexes()` and use it by default #3280
 ...
 * fix(collection): use createIndex() instead of deprecated createIndexes() #3280
 ...
 * test: improve unique validator test by making create run before createIndexes #5595 #5562
 ...
 * fix(model): make createIndexeses() run with autoIndex: false unless called internally #5328 #5324 #5317
 ...
 * fix(model): ensure `createIndexes()` never calls back in the same tick #4246
 ...
 * fix(model): bluebird unhandled rejection with createIndexeses() on init #3837
 ...
 * fix(model): mapReduce, createIndexeses, remove, and save properly return ES2015 promises #3795 #3628 #3595 [TrejGun](https://github.com/TrejGun)
 ...
 * docs; clarify createIndexes #3156
 ...
 * added; promise support to model.createIndexeses()
...
==================
  ...
  * docs; add createIndexes error handling example
  * docs; README
...
==================
  ...
  * docs; add createIndexes production notes
  * docs; fix spelling
...
===================
  ...
  * fixed; honor the `safe` option in all createIndexes calls
