 ...
 * - 'useCreateIndex': false by default. Set to `true` to make Mongoose's default index build use `createIndex()` instead of `createIndexes()` to avoid deprecation warnings from the MongoDB driver.
 ...
 * @param {Boolean} [options.useCreateIndex=true] Mongoose-specific option. If `true`, this connection will use [`createIndex()` instead of `createIndexes()`](/docs/deprecations.html#createIndexes) for automatic index builds via [`Model.init()`](/docs/api.html#model_Model.init).
