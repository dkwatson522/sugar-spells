...
* Fix writeConcern in Db.prototype.createIndexes (Issue #1231, https://github.com/Qard)
...
* NODE-220 don't throw error if createIndexes errors out in Gridstore
...
* Uses createIndexes if available for createIndexes/createIndex
...
* Added name parameter to createIndex/createIndexes to be able to override index names larger than 128 bytes
...
* Correctly throw error if an attempt is made to execute an insert/update/remove/createIndex/createIndexes with safe enabled and no callback
...
0.9.9.1 2012-02-15
------------------
* Better handling of safe when using some commands such as createIndex, createIndexes, addUser, removeUser, createCollection.
...
* Added dropDups and v option to createIndex and createIndexes.
...
* createIndexes command can be executed without a callback (Issue #438)
...
--------------------
* Fixes incorrect scope for createIndexes error wrapping (Issue #419) https://github.com/ritch
...
* Fix for errors occurring in createIndexes, Issue #326
