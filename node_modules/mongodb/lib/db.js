...
const createIndexes = require('./operations/db_ops').createIndexes;
 ...
 * @return {Promise} returns Promise if no callback passed
 */
Db.prototype.createIndexes = deprecate(function(name, fieldOrSpec, options, callback) {
  if (typeof options === 'function') (callback = options), (options = {});
  options = options || {};

  return executeLegacyOperation(this.s.topology, createIndexes, [
    this,
    name,
    fieldOrSpec,
    options,
...
}, 'Db.createIndexes is deprecated as of MongoDB version 3.0 / driver version 2.0');
