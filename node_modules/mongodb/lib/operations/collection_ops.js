...
const createIndexesDb = require('./db_ops').createIndexes;
 ...
 * @param {Collection~resultCallback} [callback] The command result callback
 */
function createIndexes(coll, fieldOrSpec, options, callback) {
  createIndexesDb(coll.s.db, coll.collectionName, fieldOrSpec, options, callback);
}
